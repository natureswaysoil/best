...
export default function CartPage() {
  ...
  const checkout = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/create-cart-checkout-session', { method: 'POST', headers: { 'content-type': 'application/json' }, body: JSON.stringify({ items, couponCode: 'SAVE15', successPath: '/order-success?session_id={CHECKOUT_SESSION_ID}', cancelPath: '/cart' }) });
