...
export default function LawnRepairPage() {
  return (
    <Layout>
      <SEO title="Organic Lawn Repair & Recovery | Nature's Way Soil" description="Repair thin, patchy, or stressed lawns with organic liquid fertilizer and living soil biology. Pet- and kid-safe, made fresh weekly on our family farm." url="https://www.natureswaysoil.com/lawn-repair" type="website" />
