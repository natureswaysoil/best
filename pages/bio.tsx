...
export default function BioPage() {
  return (
    <Layout>
      <SEO title="About Our Family Farm | Nature's Way Soil" description="Meet the family farm behind Nature's Way Soil — organic liquid fertilizers, activated biochar, and living compost made fresh weekly in Snow Hill, NC." url="https://www.natureswaysoil.com/bio" type="website" />
