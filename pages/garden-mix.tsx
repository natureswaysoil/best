...
export default function GardenMixPage() {
  const product = getProductById('NWS_013');
  ...
  return (
    <Layout>
      <Head>
        <title>Garden Mix Living Compost | Nature&apos;s Way Soil</title>
        <meta
          name="description"
          content="Living Compost with Worm Castings & Biochar for raised beds and containers. Shop direct with secure Stripe + Link checkout."
        />
        <link rel="canonical" href="https://natureswaysoil.com/garden-mix" />
      </Head>
      ...
      <main className="bg-stone-50 text-gray-900">
        <section className="bg-gradient-to-br from-nature-green-900 via-nature-green-800 to-green-700 py-16 text-white">
          <div className="max-w-6xl mx-auto px-4 grid lg:grid-cols-2 gap-10 items-center">
            <div>
              <p className="font-bold uppercase tracking-wide text-green-100">Garden Mix</p>
              <h1 className="text-4xl md:text-5xl font-black mt-2 mb-4">Living Compost with Worm Castings & Biochar</h1>
              <p className="text-lg text-green-50 mb-6">Concentrated biology-first compost blend for raised beds, transplants, and containers where root-zone performance matters.</p>
            ...
            <img src="https://m.media-amazon.com/images/I/61NvBtKjQ4L._AC_SL1254_.jpg" alt={product.name} className="w-full rounded-2xl shadow-xl bg-white" />
          </div>
        </section>

        <section className="max-w-6xl mx-auto px-4 py-14 grid md:grid-cols-2 gap-10">
          <div>
            <h2 className="text-2xl font-black mb-4">Why It Works</h2>
