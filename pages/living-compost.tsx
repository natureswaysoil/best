...
export default function LivingCompostPage() {
  return (
    <Layout>
      <SEO title="Living Compost & Worm Castings | Nature's Way Soil" description="Biologically active living compost and vermicompost that rebuild soil life, structure, and fertility. Organic, made fresh weekly on our NC family farm." url="https://www.natureswaysoil.com/living-compost" type="website" />
