...
export default function SoilBoostPage() {
  return (
    <Layout>
      <SEO title="Soil Boost — Organic Soil Amendment | Nature's Way Soil" description="Restore tired soil with humic, kelp, and microbial amendments. Improve structure, water retention, and fertility. Organic, pet- and kid-safe." url="https://www.natureswaysoil.com/soil-boost" type="website" />
