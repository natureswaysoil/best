...
export default function HeroVideo() {
  ...
  return (
    <section className="relative h-[92vh] w-full overflow-hidden flex items-center justify-center">
      ...
      {/* Overlay tint + gradient for readability */}
      ...
      <div className="relative z-10 text-center text-white px-4 md:px-8">
        <img src="/images/logo-with-tagline.png" alt="Nature's Way Soil" className="mx-auto mb-4 w-40 md:w-56 drop-shadow" />
